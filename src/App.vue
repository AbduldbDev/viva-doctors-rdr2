...
import PatientTab from "./components/PatientTab.vue";
import InventoryLogsTab from "./components/InventoryLogsTab.vue";
import MedikoLegalTab from "./components/MedikoLegalTab.vue";
import PrescriptionTab from "./components/PrescriptionTab.vue";
import OfficialReceiptTab from "./components/OfficialReceiptTab.vue";
import IncidentReportTab from "./components/IncidentReportTab.vue";
import PatientRecordTab from "./components/PatientRecordTab.vue";
...
const TABS = [
  ...
  { id: "mediko", label: "Mediko Legal", component: MedikoLegalTab },
  { id: "prescription", label: "Prescription", component: PrescriptionTab },
  { id: "receipt", label: "Receipt", component: OfficialReceiptTab },
  { id: "incident", label: "Incident", component: IncidentReportTab },
  {
    id: "lawmen_training",
    label: "Lawmen Training",
    component: LawmenTrainingTab,
  },
  {
    id: "patient_record",
    label: "Patient Record",
    component: PatientRecordTab,
  },
  {
    id: "all_patient_record",
...
function selectTab(id) {
  activeTab.value = id;
  sidebarOpen.value = false; // auto-collapse after picking a tab (optional UX)
}
